...
const appearanceCls = {
  primary: cn(primaryLightCls, primaryDarkCls),
  secondary: cn(secondaryLightCls, secondaryDarkCls),
  text: cn(textLightCls, textDarkCls),
  link: cn(linkLightCls, linkDarkCls),
  danger: cn(dangerLightCls, dangerDarkCls),
};
...
export const Button = React.forwardRef(
  (
    { className, ...props }: ButtonProps & ButtonHTMLAttributes<HTMLButtonElement>,
    ref: React.Ref<HTMLButtonElement>
  ) => {
    return <BaseButton ref={ref} className={cn('text-sm h-10', className)} {...props} />;
  }
);
...
export const SmallButton = React.forwardRef(
  (
    ...
    return <BaseButton ref={ref} className={cn('text-sm h-8', className)} {...props} />;
  }
);
...
export const LargeButton = React.forwardRef(
  (
    ...
    return <BaseButton ref={ref} className={cn('text-base h-11', className)} {...props} />;
  }
);
...
export const XLargeButton = React.forwardRef(
  (
    ...
    return <BaseButton ref={ref} className={cn('text-lg h-14', className)} {...props} />;
  }
);
