...
export const UploadBankStatement = ({
  ...
  return (
    <>
      <div
        className="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50"
        role="alert"
      >
        <svg
        ...
        <div>
          <span className="font-medium">Приложение заботится о вашей конфиденциальности!</span> Оно
          не хранит и не передает персональные данные. Из выписки оно извлекает лишь необходимые
          сведения — категорию, дату и сумму.
        </div>
      </div>
